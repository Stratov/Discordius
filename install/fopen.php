...
if( ($fp = fopen( "../modules/global/config/database.php", "w" ) ) )
{
...
if( ($fp = fopen( "../modules/global/config/email.php", "w" ) ) )
{
...
\$config['name'] = '".GetParam( $_POST, 'flipidingue', 'Un RPG multijoueurs en 2D' )."'; //Nom de votre jeu
...
\$config['description'] = '<h2>Flipidingue Multijoueurs</h2><p>Bienvenue sur le tout nouveau RPG <strong>Flipidingue/</strong>, Comme son nom l'indique, il s'agit d'un tout nouveau RPG se jouant principalement en multijoueurs. Doté d'un style 2D "rétro", tout est mis en oeuvre pour que le jeu sois très vite accrocheur. Systeme de combat, vente/revente d'objet, histoire, quête, interaction entre les joueurs et les bots il y a tout ce qui faut pour jouer comme dans son enfance.'; //Description du jeu
?>";

$canWrite_game = false;

if( ($fp = fopen( "../modules/global/config/game.php", "w" ) ) )
{
