    ...
    .complete(function(){
        setTimeout(check,5000);
			...
			<div id="contacts" style="float: right;
					...
					color: #7E7E7E;
					padding-left: 10px;">
								<!--<div style="float:left; font-weight: bold"><a href="http://localhost:90/index.php/" >Accueil</a> - 
										<a href="http://tracker.openrpg.fr" target="blank">Signaler un bug</a> - 
										<a href="http://docs.openrpg.fr/creer-son-jeu" target="blank">Documentation</a> - 
