...
if( in_array( 'item', $acces )
		...
		<ul class="toggle">
				...
				<?php endif ?>
				<?php if( in_array( 'pub', $acces ) || in_array( 'admin', $acces ) ) : ?>
						<li class="icn_edit_article"><?php echo html::anchor( 'pub','Pub du jeu' ); ?></li>
				<?php endif ?>
				<?php if( in_array( 'guilde', $acces ) || in_array( 'admin', $acces ) ) : ?>
						<li class="icn_edit_article"><?php echo html::anchor( 'guilde','Guilde du jeu' ); ?></li>
				<?php endif ?>
				<?php if( in_array( 'container', $acces ) || in_array( 'admin', $acces ) ) : ?>
						<li class="icn_object"><?php echo html::anchor( 'containers','Conteneurs du jeu' ); ?></li>
				<?php endif ?>
		</ul>
		<div class="clear"></div>
		<hr/>
		...
		<ul class="toggle invis">
				...
				<?php endif ?>
				<?php if( in_array( 'container', $acces ) || in_array( 'admin', $acces ) ) : ?>
						<li class="icn_object_add"><?php echo html::anchor( 'containers/insert', "Créer un conteneur"); ?></li>
				<?php endif ?>
		</ul>
		<div class="clear"></div>
		<hr/>
