...
function reset_vign()
{
		$('#body').attr('src', dir_script+'admin/images/character/none.png');
		$('.sup_character').each(function()
		{
				$(this).attr('src', dir_script+'admin/images/character/default.png');
		});
}
...
{
		if( file == 'none.png')
				$('#'+id).attr('src', dir_script+'admin/images/character/default.png');
		else
				$('#'+id).attr('src', dir_script+'admin/images/character/'+dir+'/'+type+'/'+ file);
}